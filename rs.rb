...
yum_package "test-reporting-service" do
...
cookbook_file "/etc/httpd/conf.d/rs.conf" do
  source "apache/rs-secure.conf"
  owner "root"
  group "root"
  mode "0400"
  action :create
