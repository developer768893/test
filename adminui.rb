...
cookbook_file "/etc/httpd/conf.d/adminui-secure.conf" do
  source "apache/adminui-secure.conf"
  owner "root"
  group "root"
  mode "0400"
  action :create
